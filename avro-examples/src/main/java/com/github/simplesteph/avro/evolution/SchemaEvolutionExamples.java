...
public class SchemaEvolutionExamples {
    public static void main(String[] args) throws IOException {
        ...
        CustomerV1 customerV1 = CustomerV1.newBuilder()
                ...
                .setWeight(75f)
                .build();
        log.info("Customer V1 = " + customerV1.toString());
        ...
        log.info("successfully wrote customerV1.avro");

        // we read it using the v2 schema
        log.info("Reading our customerV1.avro with v2 schema");
        ...
        while (dataFileReaderV2.hasNext()) {
            ...
            log.info("Customer V2 = " + customerV2read.toString());
        }

        log.info("Backward schema evolution successful\n\n\n");
        ...
        CustomerV2 customerv2 = CustomerV2.newBuilder()
                ...
                .build();
        log.info("Customer V2 = " + customerv2.toString());
        ...
        log.info("successfully wrote customerV2.avro");

        // we read it using the v2 schema
        log.info("Reading our customerV2.avro with v1 schema");
        ...
        while (dataFileReader.hasNext()) {
            ...
            log.info("Customer V1 = " + customerV1Read.toString());
        }

        log.info("Forward schema evolution successful");
